...
<?php $sandbox_comment_alt = 0 ?>
				...
				<div id="comments-list" class="comments">
					<h3 class="commentHeading"><?php printf($comment_count > 1 ? __('<span>%d</span> Comments', 'sandbox') : __('<span>One</span> Comment', 'sandbox'), $comment_count) ?></h3>
...
<?php $sandbox_comment_alt = 0 ?>
				...
				<div id="trackbacks-list" class="comments">
					<h3 class="commentHeading"><?php printf($ping_count > 1 ? __('<span>%d</span> Trackbacks', 'sandbox') : __('<span>One</span> Trackback', 'sandbox'), $ping_count) ?></h3>
...
<?php $req = get_option('require_name_email'); // Checks if fields are required. Thanks, Adam. ;-) ?>
				...
				<div id="respond">
					<h3 class="commentHeading"><?php _e( 'Post a Comment', 'sandbox' ) ?></h3>
